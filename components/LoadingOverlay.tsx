...
//            className={`fixed inset-0 z-[999] flex items-center justify-center backdrop-blur-md ${!isVisible ? 'pointer-events-none' : ''}`}>
...
//           <div className="relative z-10 flex flex-col items-center justify-center text-center h-full w-full pointer-events-none">
//             <Image
